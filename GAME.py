...
def banner():
	print('''%s
 ______        _       _______     ___  ____    ______   ________  ____   ____  _____  _____     
|_   _ `.     / \     |_   __ \   |_  ||_  _|  |_   _ `.|_   __  ||_  _| |_  _||_   _||_   _|    
  | | `. \   / _ \      | |__) |    | |_/ /      | | `. \ | |_ \_|  \ \   / /    | |    | |      
  | |  | |  / ___ \     |  __ /     |  __'.      | |  | | |  _| _    \ \ / /     | |    | |   _  
 _| |_.' /_/ /   \ \_  _| |  \ \_  _| |  \ \_   _| |_.' /_| |__/ |    \ ' /     _| |_  _| |__/ | 
|______.'|____| |____||____| |___||____||____| |______.'|________|     \_/     |_____||________| 
                                                                                                 

"""%(N))                                                    
───────────────────────────────────────────────────────
 [\x1b[1;96m+%s] Nama       :  Md Kawsar Islam 
 [\x1b[1;96m+%s] WhatsApp   : 01909576651
 [\x1b[1;96m+%s] Facebook   : Md Kawsar Islam 
 [\x1b[1;96m+%s] Github      : https://github.com/devil01909
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
def kontol():
    os.system("clear")
    print(f"""    
...
{P}[•]{B}----------------------------------------------------{P}[•]
{B} |
{P}[•] AUTHOR: Md Kawsar Islam 
{P}[•] WHATSAPP: 01909576651
{B}[•] FACEBOOK: Md Kawsar Islam""")
def licensi():#line:42
  try :#line:43
    os .system ('clear')
    kontol()
    print (f"""
{U}[{P}1{U}]{P} For Api key
{U}[{P}2{U}]{P} Not Api Key
{U}[{P}3{U}]{P} Keluar {U}[{H}Exit{U}]{H}
""")#line:49
    OOO00O0OOO00OO00O =input (f"{H}[{P}?{H}]{P} Choose :{K} ")#line:50
    if OOO00O0OOO00OO00O in ['1','01']:#line:51
      print (f"{H}[{P}!{H}]{P} Anda Akan Diarahkan Ke Whatsapp...");time .sleep (3 );os .system ('xdg-open https://wa.me/+8801909576651?text=Bang+Yogi+Beli+Lisensi');exit ()#line:52
